...
INSERT INTO `branches` (`branch_id`, `branch_name`, `branch_address`, `branch_phone`, `branch_type`) VALUES (1, 'Skyline', 'Basant Street - Near City Park', '+21-2565656', 'sales'),
(2, 'Freedom Plaza', 'Civil Street - Adjacent to Alborz Shopping Complex', '+26-5353535', 'damage'),
(3, 'Airway Heights', 'Village Road - Corner of 13th Lane', '+26-4545454', 'sales'),
(4, 'Republic Square', 'Republic Circle - Next to National Bank', '+21-4343221', 'sales,damage');
...
INSERT INTO `insurance` (`insurance_id`, `insurance_name`) VALUES (1, 'Auto Insurance'), (2, 'Fire Insurance'), (3, 'Life Insurance');
