...
const Employees = () => {
  ...
  useDocumentTitle("User Panel - Employees");
  ...
  return (
    <div>
      ...
      <Dialog fullScreen={fullScreen} open={openEdit} onClose={handleEditClickClose} aria-labelledby="responsive-dialog-title">
        <h1 className="emp-title">Edit Employee Information</h1>
        <DialogContent>
          <div className="md:flex items-center">
            <div className="md:w-72 flex flex-col contact-item">
              <label className="text-end leading-none text-gray-800">Employee ID</label>
              <input
                onChange={(e) => {
            ...
            <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
              <label className="text-end leading-none text-gray-800">Employee Name</label>
              <input
                onChange={(e) => {
          ...
          <div className="md:flex items-center mt-8">
            <div className="md:w-72 flex flex-col">
              <label className="text-end leading-none text-gray-800">National ID</label>
              <input
                onChange={(e) => {
            ...
            <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
              <label className="text-end leading-none text-gray-800">Salary</label>
              <input
                onChange={(e) => {
          ...
          {wrongInfo ? (
            <div className="wrong-info mt-10">
              <p>Please enter complete and correct information</p>
            </div>
          ) : null}
        </DialogContent>
      ...
      <Dialog fullScreen={fullScreen} open={openRegister} onClose={handleRegisterClickClose} aria-labelledby="responsive-dialog-title">
        <h1 className="emp-title">Register New Employee</h1>
        <DialogContent>
          <div className="md:flex items-center">
            <div className="md:w-72 flex flex-col contact-item">
              <label className="text-end leading-none text-gray-800">User ID</label>
              <input
                onChange={(e) => {
      ...
      <Dialog fullScreen={fullScreen} open={openDelete} onClose={handleDeleteClickClose} aria-labelledby="responsive-dialog-title">
        <h1 className="emp-title">Delete Employee</h1>
        <DialogContent>
          <div className="md:flex items-center">
            <div className="md:w-72 flex flex-col contact-item">
              <label className="text-end leading-none text-gray-800">Employee ID</label>
