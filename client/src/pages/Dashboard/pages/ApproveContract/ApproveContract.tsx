...
const ApproveContract = () => {
  ...
  useDocumentTitle("Insurance Companions User Panel - Approve Insurance Policies");
            ...
            <TableBody>
              {contracts.map((contract) => (
                ...
                >
                  ...
                  <TableCell align="center">{contract.insurance_id == 1 ? <p>Car Insurance</p> : contract.insurance_id == 2 ? <p>Fire Insurance</p> : <p>Life Insurance</p>}</TableCell>
                  <TableCell align="center">
