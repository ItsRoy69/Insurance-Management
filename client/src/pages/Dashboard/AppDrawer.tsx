        ...
        <Toolbar className="dashboard-toolbar">
          {open ? (
            <div style={{ margin: "auto" }}>
              <h1 style={{ display: "inline-block" }}>Insurance Assistants</h1>
      ...
      >
        <DrawerHeader>
          <div>
            ...
            {props.user_type == "user" ? <p className="user-role bg-sky-500 text-light">User</p> : props.user_type == "admin" ? <p className="user-role bg-green-500 text-light">Admin</p> : props.user_type == "manager" ? <p className="user-role bg-red-500 text-light">Manager </p> : <p className="user-role bg-violet-600 text-light">Chief </p>}
          </div>
        </DrawerHeader>
        <Divider />
