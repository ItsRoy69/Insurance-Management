...
const HomePage = () => {
  useDocumentTitle("Insurance Companions | Buy Insurance Online");
          ...
          <div className="mx-auto max-w-2xl py-32 ">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                Introducing the new Insurance Companions panel! {" "}
                <a
                  style={{
                    position: "relative",
                    left: "-2px"
            ...
            <div className="text-center">
              <h3 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Insurance Companions; Managing and Buying Insurance Online</h3>
              <p className="mt-6 text-lg leading-8 text-gray-600">In a few minutes, purchase the insurance you need with the smart Insurance Companions system and stay protected from damages</p>
