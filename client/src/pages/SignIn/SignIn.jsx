...
const Signin = () => {
  ...
  useDocumentTitle("Login to the Insurance Companion User Panel");
                  ...
                  <form onSubmit={handleLogin} className="text-end space-y-4 md:space-y-6">
                    ...
                    {notValidEmail ? (
                      <div className="wrong-info">
                        <p>The entered email does not exist in the system</p>
                      </div>
                    ) : null}
                    {notValidPassword ? (
                      <div className="wrong-info">
                        <p>The entered password is incorrect</p>
                      </div>
                    ) : null}
                    {validPassword && validEmail ? (
                      <div className="right-info">
                        <p>Login successful, redirecting to the panel</p>
                      </div>
                    ) : null}
